...
public:
	Plano(Ogre::SceneNode* sceneNode, string name, string matName = "Plano", Vector3 u = Vector3::UNIT_Y, Ogre::Real f = 0, int width = 1080, int height = 800, int numWsegments = 100,
	...
	void setReflex(Camera* camRef, Vector3 u = Vector3::UNIT_Y, Ogre::Real f = 0, int width = 1080, int height = 800);
